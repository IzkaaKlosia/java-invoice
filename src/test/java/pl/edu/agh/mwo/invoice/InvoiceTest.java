...
public class InvoiceTest {
    ...
    public void testInvoiceHasNumber(){
        int number = invoice.getRandomNumber();
    ...
    @Test
    public void testInvoiceNumberAreDifferentforDifferentInvoices(){
        int number1 = invoice.getRandomNumber();
        int number2 = new Invoice().getRandomNumber();
        Assert.assertEquals(invoice.getRandomNumber(), invoice.getRandomNumber()); // ? nie skonczone
    }

    @Test
    public void testPrint(){
        Product product1 = new OtherProduct("Pinezka", new BigDecimal("0.01"));
        ...
        String lines[] = printedInvoice.split("\\r?\\n");
        Assert.assertEquals(4, lines.length);
        Assert.assertEquals("Numer Faktury: "+ invoice.getNumber(), lines[0]);
        Assert.assertEquals(product1.getName()+" "+ quantity1 + " " + product1.getPrice(),lines[1]);
        Assert.assertEquals(product2.getName()+" "+ quantity2 + " " + product2.getPrice(),lines[2]);
    ...
    public void testPrintDuplicate(){
        ...
        invoice.addProduct(product1, quantity1);
        invoice.addProduct(product1, quantity2);
        ...
        Assert.assertEquals("Numer Faktury: "+ invoice.getNumber(), lines[0]);
        Assert.assertEquals(product1.getName()+" "+ totalQuantity + " " + product1.getPrice(),lines[1]);
